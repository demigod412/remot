...
<head>
    ...
    <title>@yield('title', 'Account') — {{ gs()->site_name ?? 'Job Station' }}</title>
...
<div class="auth-form-panel">
    ...
    <div class="auth-form-inner">
        ...
        {{-- Title + subtitle --}}
        <h1 style="font-size:32px;font-weight:600;letter-spacing:-1px;margin:0 0 10px;color:var(--fg);">@yield('heading', 'Welcome back.')</h1>
        <p style="font-size:14.5px;color:var(--fg-3);line-height:1.55;margin:0 0 32px;">@yield('subheading')</p>
    ...
    <div style="font-size:11.5px;color:var(--fg-4);padding-top:20px;margin-top:auto;">
        Need help? <a href="{{ route('contact') }}" style="color:var(--fg-3);text-decoration:none;">Contact support</a>
    </div>
</div>
...
<div class="auth-brand-panel">
    ...
    <div style="flex:1;display:flex;flex-direction:column;justify-content:center;position:relative;">
        ...
        <p style="font-size:15.5px;color:rgba(255,255,255,0.8);line-height:1.55;max-width:400px;margin:0 0 40px;">
            Join 38,000+ workers earning coins on {{ gs()->site_name ?? 'Job Station' }} every day. Instant microtasks, hiring jobs, and long-term contracts — one wallet.
        </p>
    ...
    <div style="display:flex;gap:20px;font-size:11.5px;color:rgba(255,255,255,0.6);position:relative;">
        <span>© {{ date('Y') }} {{ gs()->site_name ?? 'Job Station' }}</span>
        <span>·</span>
        <a href="{{ url('/terms') }}" style="color:rgba(255,255,255,0.6);text-decoration:none;">Terms</a>
        <span>·</span>
        <a href="{{ url('/privacy') }}" style="color:rgba(255,255,255,0.6);text-decoration:none;">Privacy</a>
    </div>
</div>
