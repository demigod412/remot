...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin'); ?> — <?php echo e(gs()->site_name ?? 'Job Station'); ?></title>
...
<div class="adm-form-panel">
    ...
    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:auto;padding-bottom:20px;">
        <a href="<?php echo e(route('admin.login')); ?>" style="display:inline-flex;align-items:center;gap:8px;text-decoration:none;">
    ...
    <div class="adm-form-inner">
        ...
        <h1 style="font-size:32px;font-weight:600;letter-spacing:-1px;margin:0 0 10px;color:var(--fg);"><?php echo $__env->yieldContent('heading', 'Admin console access.'); ?></h1>
        <p style="font-size:14.5px;color:var(--fg-3);line-height:1.55;margin:0 0 36px;"><?php echo $__env->yieldContent('subheading', 'Staff only. All sign-in attempts are logged and attributed to your identity.'); ?></p>
    ...
    <div style="font-size:11.5px;color:var(--fg-4);padding-top:20px;margin-top:auto;">
        Locked out? <a href="<?php echo e(route('contact')); ?>" style="color:var(--fg-3);text-decoration:none;">Contact support</a>
    </div>
</div>
    ...
    <div style="flex:1;display:flex;flex-direction:column;justify-content:center;position:relative;">
        ...
        <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:12px;margin-top:48px;max-width:440px;">
            ...
            <div style="padding:14px 16px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);border-radius:10px;">
                <div style="font-size:20px;font-weight:600;color:white;letter-spacing:-0.5px;font-family:ui-monospace,monospace;"><?php echo e($v); ?></div>
                <div style="font-size:11px;color:rgba(255,255,255,0.55);margin-top:2px;"><?php echo e($l); ?></div>
            </div>
...
<?php /**PATH /var/www/resources/views/admin/layouts/auth.blade.php ENDPATH**/ ?>