...
<div class="flex h-screen overflow-hidden" x-data="{
    ...
    >
        ...
        <nav style="flex:1; overflow-y:auto; padding:12px 10px; display:flex; flex-direction:column; gap:2px;">
            ...
            <div x-data="{ open: <?php echo e(request()->routeIs('admin.works*', 'admin.submissions*', 'admin.categories*') ? 'true' : 'false'); ?> }">
                <button @click="open = !open"
                    class="sidebar-link <?php echo e(request()->routeIs('admin.works*', 'admin.submissions*', 'admin.categories*') ? 'active' : ''); ?>"
                    title="Works">
                ...
                <div x-show="open && sidebarOpen" x-transition style="padding-left:12px; margin-top:2px; display:flex; flex-direction:column; gap:2px;">
                    ...
                    <a href="<?php echo e(route('admin.submissions.index')); ?>" class="sidebar-link btn-sm <?php echo e(request()->routeIs('admin.submissions*') ? 'active' : ''); ?>">
                        <i data-lucide="file-check" style="width:14px;height:14px;"></i>
                        <span>Submissions</span>
                        <?php $pendingSubs = \App\Models\WorkSubmission::where('status', 1)->count(); ?>
                        <?php if($pendingSubs > 0): ?>
                        <span class="mono" x-show="sidebarOpen" style="margin-left:auto;font-size:10px;padding:2px 6px;background:var(--urgent-soft);color:var(--urgent);border-radius:4px;"><?php echo e($pendingSubs); ?></span>
                        <?php endif; ?>
                    </a>
