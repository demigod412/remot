...
<div style="display:grid; grid-template-columns:repeat(4,1fr); gap:14px; margin-bottom:20px;" class="sub-stat-grid">
    ...
    <div class="card" style="padding:16px;">
        ...
        <div style="display:flex; align-items:baseline; gap:3px;">
            <span style="font-size:14px; color:var(--coin); font-family:ui-monospace,monospace; font-weight:600;"><?php echo e(coinSymbol()); ?></span>
            <span class="mono" style="font-size:22px; font-weight:600; letter-spacing:-0.5px; color:var(--coin);"><?php echo e(number_format($totalEarned)); ?></span>
        </div>
    </div>
</div>
    ...
    <div style="display:flex; align-items:flex-start; gap:16px;">
        ...
        <div style="text-align:right; flex-shrink:0; display:flex; flex-direction:column; align-items:flex-end; gap:8px;">
            ...
            <div style="display:flex; align-items:baseline; gap:3px;">
                ...
                <span class="mono" style="font-size:20px; font-weight:600; color:var(--coin);"><?php echo e($work->coins_per_worker); ?></span>
            </div>
            <?php elseif($work): ?>
